      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-16 relative">
          <form onSubmit={handleSearch} className="group relative">
            ...
            />
            <button type="submit" className="absolute right-4 top-1/2 -translate-y-1/2 bg-white text-black p-4 rounded-full hover:bg-blue-600 hover:text-white transition-all shadow-xl z-20">
