...
export const Home = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* HERO SECTION */}
      <section className="relative w-full flex flex-col items-center justify-center pt-40 pb-0 px-6 border-b border-transparent">
        {/* Background Image */}
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          <h1 className="text-7xl md:text-9xl font-black tracking-tighter mb-6 leading-none drop-shadow-2xl">
            ...
            <sup className="text-4xl md:text-5xl ml-1">&reg;</sup>
          </h1>
      ...
      <section className="px-6 relative z-10 mt-24 mb-24">
