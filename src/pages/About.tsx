export function About() {
  return (
    <div className="min-h-screen bg-black text-white pt-16 px-6 pb-20 relative overflow-hidden font-sans">
        ...
        <div className="grid gap-8">
          <section className="group bg-zinc-900/30 p-10 md:p-14 rounded-[3rem] border border-white/5 hover:border-white/10 transition-all backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="space-y-6 text-zinc-400 text-lg leading-relaxed font-medium max-w-2xl">
              <p>With over <span className="text-white font-bold">40 years of authority</span>, MUSICweb® stands as one of the most enduring names in the industry. Our roots go back to the mid-1980s, beginning with the legacy of <span className="text-orange-500 font-bold">Campus Records</span> and evolving through the digital revolution.</p>
              <p>Originally established as a hub for physical media, the brand has transitioned from brick-and-mortar beginnings to a sophisticated digital technology stack, encompassing a premium domain portfolio including <span className="text-white font-mono text-base border-b border-white/20">musicweb.com</span> and <span className="text-white font-mono text-base border-b border-white/20">musikweb.com</span>.</p>
            </div>
          </section>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            <section className="md:col-span-3 bg-gradient-to-br from-zinc-900/60 to-black p-10 md:p-12 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
              ...
              <p className="text-zinc-400 leading-relaxed font-medium relative z-10">Today, MUSICweb® is more than just a site; it's a curated intelligence engine. We provide artist insights, real-time news aggregation, and a high-end gear marketplace, serving a global community of collectors and creators.</p>
            </section>
            <section className="md:col-span-2 bg-black p-10 md:p-12 rounded-[3rem] border border-zinc-800 flex flex-col justify-center items-center text-center">
              ...
              <div className="text-3xl font-black italic text-white tracking-tighter">REACT <span className="text-zinc-600">/</span> NEXT</div>
