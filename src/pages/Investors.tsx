...
export function Investors({ onNavigate }: InvestorsProps) {
  return (
    // ✅ Tightened top space for a cleaner look
    <div className="min-h-screen bg-[#1a1d2e] text-white font-sans pt-10 pb-20 px-6">
      
      {/* BRAND HEADER (Smaller text-5xl and tighter margins) */}
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        ...
        <div className="bg-[#111] p-10 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-white/10 transition-all">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold">Registered Trademarks</h2>
          </div>

          <div className="space-y-6 relative z-10">
            {/* TRADEMARK 1 (Italic Brand + Rainbow Web) */}
            <div className="bg-[#1a1d2e] p-6 rounded-xl border border-white/5">
              <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Registration #3666249</div>
              ...
              <p className="text-xs text-gray-400">Class 35: Online Retail Store Services featuring downloadable music and audio.</p>
            </div>

            {/* TRADEMARK 2 (Italic Brand + Rainbow Web) */}
            <div className="bg-[#1a1d2e] p-6 rounded-xl border border-white/5">
              <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Registration #3578767</div>
              <div className="text-3xl font-black mb-2 flex items-baseline">
                <span style={{ fontStyle: 'italic' }}>MUSIK</span>
                <span className="bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 bg-clip-text text-transparent">web</span>
                <span>®</span>
              </div>
              <p className="text-xs text-gray-400">Class 35: Defensive registration covering alternative spelling variations.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111] p-10 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-white/10 transition-all">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold">Domain Portfolio</h2>
          </div>

          <p className="text-gray-400 mb-8">Own the entire namespace. Includes all major extensions.</p>
          ...
          <div className="grid grid-cols-2 gap-y-4 relative z-10">
            ...
            {/* ✅ BRIGHTENED SECONDARY DOMAINS (Changed to gray-400) */}
      ...
      <div className="max-w-4xl mx-auto bg-gradient-to-b from-blue-900/20 to-blue-900/5 border border-blue-500/30 rounded-3xl p-12 text-center relative overflow-hidden">
        ...
        <h2 className="text-3xl font-black mb-4">Serious Inquiries Only</h2>
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          All assets are held by a single owner and transferable immediately via Escrow.com.
        </p>

        <button 
          onClick={() => onNavigate('contact')}
          className="bg-white text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-blue-50 transition-colors shadow-lg shadow-blue-900/20"
        >
          Contact Broker Desk
        </button>
      </div>
